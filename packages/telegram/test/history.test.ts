...
describe('shapeHistory', () => {
  ...
  test('includes from_name and from_display_name alongside the id-based from', () => {
    ...
    expect(out.messages[0]?.from).toBe('metro://telegram/default/user/333');
