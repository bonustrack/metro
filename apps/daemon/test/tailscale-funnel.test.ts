...
import { currentTunnelUrl, funnelAlreadyServing, funnelDriver, funnelUrlIn, nodeNameIn, Tunnel, tunnelWanted } from '../src/net/tunnel.ts';
import { publicBaseUrl } from '../src/files/attach-serve.ts';
import { tunnelPendingHint } from '../src/boot/connect-hint.ts';
