...
import { USAGE_PROVIDERS, windowLine, type ProviderUsage, type Usage, type UsageWindow } from '../api/usage.js';
...
const NONE =
  'Nothing reported yet. Anthropic and Codex state their remaining quota on every answer that passes through the gateway, so this fills in after the first request; OpenRouter credits are read when this page opens.';
