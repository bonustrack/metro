---
name: refresh
description: Re-fetch the authorized agent's connector list from metro and rewrite the plugin's MCP servers, picking up added or removed connectors.
---
...
Use this after connectors were added to or removed from the agent on metro.box, or after a plugin update reset the server list.
